...
jQuery.SelectBox = function(selectobj, options) {
	...
	opt.change=opt.change || function(){};   //2012-06-15添加
	opt.bindDiv=opt.bindDiv || [];
	...
	function getSelectOptions(parentid) {
		...
		$select.children('option').each(function(index) {
			...
			if(opt.bindDiv!=null && opt.bindDiv.length>0)  //2012-06-15添加  绑定相关要显示的DIV
				li.setAttribute("bindDiv",opt.bindDiv[index]);
